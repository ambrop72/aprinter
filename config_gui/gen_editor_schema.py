...
def main():
    editor = configema.Compound('editor', title='Configuration editor', disable_collapse=True, attrs=[
        configema.Array(key='configurations', title='Configurations', elem=configema.Compound('config', key='config', ident='id_configuration', title='Configuration', collapsed=True, attrs=[
        ...
        configema.Array(key='boards', title='Boards', collapsed=True, elem=configema.Compound('board', title='Board', collapsed=True, attrs=[
